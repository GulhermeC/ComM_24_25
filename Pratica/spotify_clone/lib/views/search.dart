      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 10,),
            smalltile(context,"Latest",Colors.red,"Pop",Colors.green,"assets/ser1.jfif","assets/ser2.jfif"),
            SizedBox(height: 10,),
            smalltile(context,"Punjabi",Colors.orange,"Top 50",Colors.yellow,"assets/ser3.jfif","assets/ser4.jfif"),
            SizedBox(height: 10,),
            smalltile(context,"Pop Smoke",Colors.red[200],"Latest",Colors.green[800],"assets/ser7.jfif","assets/ser1.jfif"),
            SizedBox(height: 10,),
            smalltile(context,"Latest  ",Colors.red,"Pop",Colors.green,"assets/ser1.jfif","assets/ser2.jfif"),
            SizedBox(height: 10,),
            smalltile(context,"Punjabi",Colors.orange,"Top 50",Colors.yellow,"assets/ser3.jfif","assets/ser4.jfif"),
